...
contract EstateArea is ChainlinkClient {
    ...
    uint256 public sqftArea;
    bytes32 public latestRequestId;
    bytes32 public tokenHash;

    mapping(bytes32 => bytes32) public receiptArea;
    mapping(bytes32 => uint256) public currentRealEstateArea;
    ...
    function returnSqftArea(string memory _tokenId) public {
        ...
        ] = stringToBytes32(_tokenId);
    }

    function myCallback(bytes32 _requestId, uint256 _sqftArea)
        public
    ...
    function getAreaTokenId(string memory _tokenId)
        public
        view
        returns (uint256)
    {
